...
Connect Falustic provided by your Airtable account to seamlessly export your chat conversations and data directly into your bases.

## Prerequisites

Before you begin, ensure you have:
1. An active [Airtable account](https://airtable.com).
2. The Falustic extension installed on your browser.
...
3. Give your token a name (e.g., "Falustic").
