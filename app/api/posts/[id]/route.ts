...
// PATCH - Update post (e.g. price for exclusive posts)
export async function PATCH(
  ...
  try {
    ...
    const validationResult = patchPostSchema.safeParse(body)
    ...
    // Price: accept main currency units and convert to paise (consistent with create post)
    const priceInPaise =
