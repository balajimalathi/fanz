...
import { ChatRejectMessage } from "@/lib/websocket/types";

// POST - User rejects chat start
export async function POST(
  ...
  try {
    ...
    // Create chat:reject message
    const chatRejectMessage: ChatRejectMessage = {
      type: "chat:reject",
      timestamp: Date.now(),
      payload: {
    ...
    sendToUser(otherUserId, chatRejectMessage, io);
